...
exports.displaySignUpForm = require("./routes_lib/user/displaysignup.js").displaySignUpForm;
exports.processSignUpData = require("./routes_lib/user/processSignUpData.js").processSignUpData;
...
exports.preIndex = function(req, res, next) {
    console.log("fsdkjasdlkjflkdasjfklasdj");
    ...
    console.log("pre already registered index called");
